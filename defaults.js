...
var EURIA_STRINGS = {
  fr: {
    ...
    poweredUrl: "https://www.infomaniak.com/fr/hebergement/ai-services",
    ...
    optSave: "Enregistrer",
    optSaved: "Enregistré ✓",
    optProductHint: "Le numéro de votre produit AI Services. Pour l'obtenir : curl -H \"Authorization: Bearer VOTRE_JETON\" https://api.infomaniak.com/1/ai — puis reportez le champ « product_id » de la réponse.",
    optNeedAccess: "Pas encore d'accès ?",
    optOrderProduct: "Commander AI Services (1 M de crédits offerts)",
    optCreateToken: "Créer un jeton API",
    optServiceUrl: "https://www.infomaniak.com/fr/hebergement/ai-services",
  ...
  en: {
    ...
    poweredUrl: "https://www.infomaniak.com/en/hosting/ai-services",
    ...
    optSave: "Save",
    optSaved: "Saved ✓",
    optProductHint: "Your AI Services product number. To get it: curl -H \"Authorization: Bearer YOUR_TOKEN\" https://api.infomaniak.com/1/ai — then copy the \"product_id\" field from the response.",
    optNeedAccess: "No access yet?",
    optOrderProduct: "Get AI Services (1M free credits)",
    optCreateToken: "Create an API token",
    optServiceUrl: "https://www.infomaniak.com/en/hosting/ai-services",
